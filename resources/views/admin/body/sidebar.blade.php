            ...
            <ul id="side-menu">
                ...
                <li>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li><a href="{{route('all.subcategory')}}">Sub Category</a></li>
                        <li><a href="{{route('all.subsubcategory')}}">Sub-Sub Category</a></li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li><a href="peity-chart.html">Manage Product</a></li>
                    </ul>
                </li>

                <li>
                    <a class="waves-effect" href="javascript:void(0);" aria-expanded="false"><i class="icon-location-pin fa-fw"></i> <span class="hide-menu"> Slider</span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li> <a href="map-google.html">Manage Slider</a> </li>
                    </ul>
                </li>
